...
#include "logic/fsm/fsmStatesDemo.hpp"
...
auto main() -> int {
    ...
    dumptruckFSM->addToStateTable(
        ...
        {.stateAction = []() { return Logic::FSMDemo::initStateAction([]() {}); },
         .color{Hardware::RGB_LED::PredefinedColors::BLUE}});
    dumptruckFSM->addToStateTable(
        Logic::FSM::DumptruckUltra::FSMState::PICKUP,
        {.stateAction{[arm{arm.get()}]() { return Logic::FSMDemo::pickupAction(*arm); }},
         .color{Hardware::RGB_LED::PredefinedColors::CYAN}});
    dumptruckFSM->addToStateTable(
        Logic::FSM::DumptruckUltra::FSMState::DISPENSE,
        {.stateAction{[dispenser{dispenser.get()}]() { return Logic::FSMDemo::dispenseAction(*dispenser); }},
